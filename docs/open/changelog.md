...
各位开发者：
感谢大家长期以来对弹弹play开放平台的信任与支持。为了让平台能够更稳定、更长久地服务于每一位认真做项目的开发者，我们计划在近期上线项目分层与配额管理机制。本公告将说明调整的背景、具体方案及过渡安排，希望得到您的理解与配合。

全文：[https://dev.dandanplay.com/PublicPage/Quota](https://dev.dandanplay.com/PublicPage/Quota)

省流版：
1. 开放平台即将对应用做出分层，并按照层级提供对应的免费额度；
2. 默认配额不会影响绝大部分开源项目，以及个人测试目的的接入；
3. 您可以从开发者中心查看到您的应用的额度使用情况；
4. 商业项目需要付费使用，如有需求请联系我们；
5. 配额功能将于2026年6月25日上线；
6. “个人测试（基础）”层级，以及6月1日前未将旧版AppId关联到开放平台的应用会立刻生效。

请先浏览公告原文。如有疑问或希望申请更高额度，请在后台留言、发邮件或通过联系开放平台运营方申请。

## 2026年5月7日

### 开发者自助服务平台 · DevCenter 上线
