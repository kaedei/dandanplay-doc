...
- [常见问题](faq/README.md)
  ...
  - [如何试用PC测试版](faq/pc-beta.md)
  - [账号、注册、登录相关问题](faq/account.md)
  - [播放器无法启动如何解决](faq/pc-cannot-start.md)
  - [弹弹play是如何加载弹幕的？](faq/load-danmaku.md)
  - [备份弹弹play的数据（PC版）](faq/pc-backup.md)
  - [弹弹play PC版性能问题汇总](faq/pc-performance.md)

- [常用功能](function/README.md)
  - [弹弹play会员](function/member.md)
  - [『弹幕外挂』](function/danmaku-overlay.md)
  - [PC版播放器内核功能对比](function/kernel-compare.html)
  - [向电视投屏播放视频和弹幕](function/cast-to-tv.html)
  - [弹弹play数据库](function/online-databases.html)
  - [使用AI语音识别为视频生成字幕](function/ai-speech-recognition.html)
  - [使用『AI视频总结』功能为视频生成大纲和总结](function/ai-video-summary.html)
